...
import fastcampus.aop.part3.aop_part4_chapter03.response.address.AddressInfoResponse
import fastcampus.aop.part3.aop_part4_chapter03.response.search.SearchResponse
...
interface ApiService {
    ...
    suspend fun getSearchLocation(
        ...
        @Query("searchtypeCd") searchTypeCd: String? = null,
